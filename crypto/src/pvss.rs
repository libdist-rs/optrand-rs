use crate::{Commitment, DleqProof, Encryptions, PublicKey, Scalar, Secret, Share, SingleDleqProof, ark_serde::{
...
where E: PairingEngine,
{
    ...
    #[serde(serialize_with = "canonical_serialize")]
    #[serde(deserialize_with = "canonical_deserialize")]
    pub gs: <Commitment<E> as AffineCurve>::Projective,
    ...
    pub sig_of_knowledge: SingleDleqProof<
        <Commitment<E> as AffineCurve>::Projective, 
        Scalar<E>
    >
}
...
where E: PairingEngine,
{
    ...
    #[serde(bound(serialize = "DleqProof<E::G1Projective, E::G2Projective, Scalar<E>>: Serialize"))]
    #[serde(bound(deserialize = "DleqProof<E::G1Projective, E::G2Projective, Scalar<E>>: Deserialize<'de>"))]
    pub proof: DleqProof<Encryptions<E>, Encryptions<E>, Scalar<E>>,
}
