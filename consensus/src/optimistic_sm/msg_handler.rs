...
impl OptRandStateMachine {
    ...
    pub(crate) fn on_new_msg(&mut self, 
        ...
        match msg {
            ...
            //     }
            // }
            // ProtocolMsg::RespVote(v, c) => {
            //     self.verify_resp_vote(&v, &c)?;
            //     ev_queue.add_event(
            //         Event::Message(
            //             sender, 
            //             NewMessage::RespVote(v, c)
            //         )
            //     );
            //     #[cfg(feature = "profile")]
            //     {
            ...
            //     }
            // }
            // ProtocolMsg::RespCert(prop, proof) => {
            //     self.verify_resp_cert(sender, &prop, &proof)?;
            //     ev_queue.add_event(
            //         Event::Message(
            //             sender,
            ...
            //     }
            // }
            // ProtocolMsg::DeliverRespCert(sh_for, d) => {
            //     self.verify_resp_cert_deliver_share(sender, sh_for, &d)?;
            //     ev_queue.add_event(
            //         Event::Message(
            //             sh_for,
            //             NewMessage::DeliverRespCert(sh_for, d)
            //         )
            //     );
            //     #[cfg(feature = "profile")]
            //     {
            ...
            // ProtocolMsg::BeaconReady(e, beacon) => {
            //     self.verify_beacon_ready(e, &beacon)?;
            //     ev_queue.add_event(
            //         Event::Message(
            //             sender, 
            //             NewMessage::BeaconReady(e, beacon)
            //         )
            //     );
            //     #[cfg(feature = "profile")]
            //     {
            ...
            //     }
            // }
            // ProtocolMsg::Ack(data, cert) => {
            //     self.verify_ack(sender, &data, &cert)?;
            //     ev_queue.add_event(
            //         Event::Message(
            //             sender,
            //             NewMessage::Ack(data, cert),
            //         )
            //     );
            //     #[cfg(feature = "profile")]
            //     {
    ...
    pub(crate) fn on_new_msg_event(&mut self, 
        ...
        match msg_ev {
            ...
            NewMessage::RespVote(v, c) => {
                self.on_verified_resp_vote(from, v, c, ev_queue)?;
                #[cfg(feature = "profile")]
                {
                    let now2 = std::time::Instant::now();
                    println!("Verified message handling profile for {}: {}", 
            ...
            NewMessage::RespCert(prop, proof) => {
                self.on_verified_resp_cert(prop, proof, ev_queue)?;
                #[cfg(feature = "profile")]
                {
                    let now2 = std::time::Instant::now();
                    println!("Verified message handling profile for {}: {}", 
            ...
            NewMessage::DeliverRespCert(from, sh) => {
                self.on_verified_resp_cert_deliver(from, sh)?;
                #[cfg(feature = "profile")]
                {
                    let now2 = std::time::Instant::now();
                    println!("Verified message handling profile for {}: {}", 
            ...
            NewMessage::BeaconShare(e, dec) => {
                self.on_new_beacon_share(from, e, dec, ev_queue)?;
                #[cfg(feature = "profile")]
                {
                    let now2 = std::time::Instant::now();
                    println!("Verified message handling profile for {}: {}", 
            ...
            NewMessage::BeaconReady(e, b) => {
                self.on_verified_beacon(e, b)?;
                #[cfg(feature = "profile")]
                {
                    let now2 = std::time::Instant::now();
                    println!("Verified message handling profile for {}: {}", 
            ...
            NewMessage::Ack(data, cert) => {
                self.on_verified_ack(from, data, cert)?;
                #[cfg(feature = "profile")]
                {
                    let now2 = std::time::Instant::now();
                    println!("Verified message handling profile for {}: {}", 
