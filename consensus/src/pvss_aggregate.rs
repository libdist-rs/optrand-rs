...
impl Context {
    ...
    pub fn new_epoch_sharing(&mut self, sender: Replica, pvec: PVSSVec) {
    ...
    pub fn new_sharing_ready(&mut self, origin: Replica, pvec: AggregatePVSS, proof: DecompositionProof) {
